  ...
  <div id="app" ref="app" class="w-100 h-100">
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-col cols="6">
          <b-navbar-nav class="ml-auto align-right">
            <b-nav-form size="sm" v-if="$route.name === 'Dashboard'">
              <b-nav-item>
                <b-button-group size="sm">
                  <notes-widget></notes-widget>
                  <b-button disabled id="sessionLabel" variant="dark">
                    {{ session_name }}
                  </b-button>
                  <b-button
            ...
            <b-nav-item-dropdown
              size="sm"
              right
              class="navbar-item-spaced align-vertical"
            >
    ...
    >
      <div class="d-block">
        ...
        ></b-form-input>
        <label class="mt-2" for="session-notes">Notes:</label>
        <b-form-textarea
          v-model="notes"
          rows="10"
          max-rows="10"
